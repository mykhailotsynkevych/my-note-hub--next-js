...
import TagsSidebarClient from './TagsSidebarClient';

const NotesSidebar = async () => {
  return (
    <div className="overflow-hidden rounded-xl border border-slate-200/80 bg-white/90 shadow-[0_24px_60px_-36px_rgba(15,23,42,0.45)] backdrop-blur">
      <div className="border-b border-slate-100 bg-[linear-gradient(135deg,#eff6ff_0%,#fffbeb_100%)] px-5 py-4">
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-sky-700">
          Tags
        </p>
        <p className="mt-1 text-sm text-slate-600">
          Choose a tag to filter your notes.
        </p>
      </div>
